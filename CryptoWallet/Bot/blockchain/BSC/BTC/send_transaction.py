...
#Функция отправки BTC с одного кошелька на другой
async def send_token_btc(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c" #контракт биткоина
    contract_abi = [
        {
            "constant": False,
            "inputs": [
