...
#Функция отправки ETH с одного кошелька на другой
async def send_token_eth(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0x2170Ed0880ac9A755fd29B2688956BD959F933F8" #контракт эфира
    contract_abi = [
        {
            "constant": False,
            "inputs": [
