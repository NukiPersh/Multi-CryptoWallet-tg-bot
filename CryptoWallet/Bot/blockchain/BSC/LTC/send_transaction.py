...
#Функция отправки LTC с одного кошелька на другой
async def send_token_ltc(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0x4338665CBB7B2485A8855A139b75D5e34AB0DB94" #контракт лайткоина
    contract_abi = [
        {
            "constant": False,
            "inputs": [
