...
#Функция отправки TON с одного кошелька на другой
async def send_token_ton(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0x76A797A59Ba2C17726896976B7B3747BfD1d220f" #контракт тонкоина
    contract_abi = [
        {
            "constant": False,
            "inputs": [
    ...
    amount_in_wei = int(amount_in_token* 10**9)
    tx = {
        'chainId': 56,
