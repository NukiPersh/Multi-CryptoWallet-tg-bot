...
#Функция отправки TRX с одного кошелька на другой
async def send_token_trx(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0xCE7de646e7208a4Ef112cb6ed5038FA6cC6b12e3" #контракт трона
    contract_abi = [
        {
            "constant": False,
            "inputs": [
    ...
    nonce = await web3.eth.get_transaction_count(sender_account.address, 'pending') 
    amount_in_wei = int(amount_in_token * 10**6)
