...
#Функция отправки usdc с одного кошелька на другой
async def send_token_usdc(sender_private_key, receiver_address, amount_in_token):
    ...
    contract_token = "0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d" #контракт usdc
    contract_abi = [
        {
            "constant": False,
            "inputs": [
